...
export default function PlatformTabs({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute top-1 bottom-1 left-1 rounded-xl bg-purple-from shadow-[0_2px_12px_-2px_rgba(168,85,247,0.6)] transition-transform duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)]"
        style={{
